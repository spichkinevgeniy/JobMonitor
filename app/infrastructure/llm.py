...
def get_vacancy_parse_agent() -> Agent[None, OutVacancyParse]:
    ...
    system_prompt = (
        ...
        "   - Для каждого skill укажи evidence — дословный фрагмент текста вакансии, по "
        "которому ты его определил. Копируй символ в символ, без пересказа и перевода. "
        "Если подтвердить фрагментом нельзя, skill не указывай.\n"
